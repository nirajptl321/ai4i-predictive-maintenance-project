...
| Hyperparameter tuning | `Topic3-Supervised Learning II-V3.pdf`, `Topic7-Decision_Trees_Interpretability_Ensembles.pdf`, guideline PDF | Tunes Decision Tree, Random Forest, and HistGradientBoostingClassifier using small validation grids. | OK |
...
| Reproducibility | Guideline PDF | Provides scripts, requirements, saved outputs, run logs, and command-line instructions. | OK |
